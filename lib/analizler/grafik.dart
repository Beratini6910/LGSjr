...
class Grafikli extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => GrafikliState();
}

class GrafikliState extends State<Grafikli> {
  ...
  Widget build(BuildContext context) {
    ...
    if(net1<=3.79&&net1>3.79){
      net1=1.5;
    }
    if(net1<=4.02&&net>3.79){
      net1=2.5;
    }
    if(net1<=4.21&&net>4.02){
      net1=3.5;
    }
    if(net1>=4.21){
      net1 = 4.5;
